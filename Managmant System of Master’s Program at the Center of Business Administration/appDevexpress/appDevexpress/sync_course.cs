...
{
    public partial class sync_course : Form
    {
        public sync_course()
        {
            InitializeComponent();
        ...
        private void sync_course_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'data_base.DataTable1' table. You can move, or remove it, as needed.
            this.dataTable1TableAdapter.Fill(this.data_base.DataTable1);
