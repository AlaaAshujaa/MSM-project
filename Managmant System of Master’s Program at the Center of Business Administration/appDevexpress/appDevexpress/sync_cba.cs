...
{
    public partial class sync_cba : Form
    {
        public sync_cba()
        {
            InitializeComponent();
        ...
        private void sync_cba_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'data_base.DataTable3' table. You can move, or remove it, as needed.
            this.dataTable3TableAdapter.Fill(this.data_base.DataTable3);
