...
{
    public partial class sync_exam : Form
    {
        public sync_exam()
        {
            InitializeComponent();
        ...
        private void sync_exam_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'data_base.DataTable2' table. You can move, or remove it, as needed.
            this.dataTable2TableAdapter.Fill(this.data_base.DataTable2);
