...
{
    public partial class sync_stcs : Form
    {
        public sync_stcs()
        {
            InitializeComponent();
        ...
        private void sync_stcs_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'data_base.DataTable' table. You can move, or remove it, as needed.
            this.dataTableTableAdapter.Fill(this.data_base.DataTable);
