...
{
    public partial class sync_grade : Form
    {
        public sync_grade()
        {
            InitializeComponent();
        ...
        private void sync_grade_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'data_base.grade_sync' table. You can move, or remove it, as needed.
            this.grade_syncTableAdapter.Fill(this.data_base.grade_sync);
