...
if(empty($Uniquenum) ||empty($Title)  || empty($studentname)  || empty($programtype) || empty($Intakecode) || empty($Institutionname) || empty($programlocation))
	{
 echo " <h4 style=\"color: red;\" align=\"center\" class='alert alert-danger'><i class='fa fa-thumbs-down'></i><br>please complete the fields</h4> "; 	
	...
	{
$stmt=$con->prepare("INSERT INTO grievance_msm(Unique_num,Title,student_name,	program_type,Intake_code,Institution_name,program_location,Course_name,lecturer_name,Assign_or_Exam,ind_or_Grop,grade_result,Project_Title,Supervisor,Evaluator,Date,grade_project,BHAP_title,Coach,Evaluator_BHAP,date_BHAP,Question,Objection,Motivation,Declaration_date)
 VALUES ('$Uniquenum','$Title','$studentname','$programtype','$Intakecode','$Institutionname','$programlocation','$Coursename','$lecturername','$AssignorExam','$indorGrop','$graderesult','$ProjectTitle','$Supervisor','$Evaluator','$Date','$gradeproject','$BHAPtitle','$Coach','$EvaluatorBHAP','$dateBHAP','$Question','$Objection','$Motivation','$Declarationdate')");
  
$stmt->execute(array($Uniquenum,$Title,$studentname,$programtype,$Intakecode,$Institutionname,$programlocation,$Coursename,$lecturername,$AssignorExam,$indorGrop,$graderesult,$ProjectTitle,$Supervisor,$Evaluator,$Date,$gradeproject,$BHAPtitle,$Coach,$EvaluatorBHAP,$dateBHAP,$Question,$Objection,$Motivation,$Declarationdate));
...
<i class='fa fa-thumbs-up'></i><br>Insert data done successfully</h4> ";
         ...
         $to="info@su-cba.com";
     $subject="My subject"; 
    $txt=$_POST['studentname']." is request Grade objection to Examination,Assignments ad Master Theses or final Project grades";
   ...
   <div class=" col-md-8 ">
       ...
       <p>In case of Master Thesis or Final Project objections&#40;review not possible&#41;,the participant is advised to object the grade in writing to the MSM Exmination Board stating the reasons for disagreement.A "motivated" objection should be field no later than four(4) weeks after notification of the Master Thesis or Final Project grade.</p>-->
        ...
        <div class="col-md-6 bg-primary">
            <label for="exampleInputName2">Participant name:</label><input type="text" class="form-control" placeholder="" name="studentname" value="<?php echo $row['first_name'].' '.$row['middle_name'].' '.$row['family_name']?>">
...
<label class="radio-inline">
  <input type="radio" name="Title" id="inlineRadio1" value="Ms"> Ms.
            ...
            <div class="row">
                <div class="col-md-6">
                <label for="exampleInputName2">Participant ID No.:</label><input type="text" class="form-control" placeholder="" name="Uniquenum" value="<?php echo $row['student_id']?>">
                </div>
...
<label class="radio-inline">
  ...
  <input type="radio" name="programtype" id="inlineRadio1" value="EP"> EP
            ...
            <label for="exampleInputName2">Intake(Group) No.:</label><input type="number" class="form-control" placeholder="" name="Intakecode">
            
            <label for="exampleInputName2">MSM or Partner Institution name:</label><input type="text" class="form-control" placeholder="" name="Institutionname">
            
            <label for="exampleInputName2">Program location(city&amp;country):</label><input type="text" class="form-control" placeholder="" name="programlocation">
            </div>
        ...
        <div class="col-md-6 bg-primary">
            ...
            <label for="exampleInputName2">Course Name:</label><input type="text" class="form-control" placeholder="" name="Coursename">
             
            <label for="exampleInputName2">Course lecturer Name:</label><input type="text" class="form-control" placeholder="" name="lecturername">
            
            <label for="exampleInputName2">Assignment or Examination:</label><input type="text" class="form-control" placeholder="" name="AssignorExam">
  ...
  <input type="radio" name="indorGrop" id="inlineRadio1" value="Group"> Group
            ...
            <div class="row">
                <div class="col-md-6">
                <label for="exampleInputName2">Grade Result:</label><input type="number" class="form-control" placeholder="" name="graderesult">
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-6 bg-primary">
            ...
            <label for="exampleInputName2">Master Thesis or Final Project Title:</label><input type="text" class="form-control" placeholder="" name="ProjectTitle">
             
            <label for="exampleInputName2">Supervisor:</label><input type="text" class="form-control" placeholder="" name="Supervisor">
            
            <label for="exampleInputName2">(External) Evaluator(s):</label><input type="text" class="form-control" placeholder="" name="Evaluator">
               
            <label for="exampleInputName2">Defense Date:</label><input type="date" class="form-control" placeholder="" name="Date">
            <div class="row">
                <div class="col-md-6">
                <label for="exampleInputName2">Grade Result:</label><input type="number" class="form-control" placeholder="" name="gradeproject">
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-6 bg-primary">
            ...
            <label for="exampleInputName2">BHAP Title:</label><input type="text" class="form-control" placeholder="" name="BHAPtitle">
             
            <label for="exampleInputName2">Coach:</label><input type="text" class="form-control" placeholder="" name="Coach">
            
            <label for="exampleInputName2">(External) Evaluator(s) BHAP:</label><input type="text" class="form-control" placeholder="" name="EvaluatorBHAP">

            <div class="row">
                <div class="col-md-6">
                <label for="exampleInputName2">Presentation and Defense Date BHAP:</label><input type="date" class="form-control" placeholder="" name="dateBHAP">
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="col-md-6 bg-primary">  
            ...
            <div class="col-md-6">
            <label for="exampleInputName2">Date:</label><input type="date" class="form-control" placeholder="" name="Declarationdate">
