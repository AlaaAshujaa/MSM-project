...
<div class="container">
  ...
  <li><a href="Exam-Assignment%20Deferment%20Request.php">Exam/Assignment Deferment Request</a></li>
</ol>
            </div>
...
<i class='fa fa-thumbs-up'></i><br>Insert data done successfully</h4> ";
              ...
              $to="info@su-cba.com";
     $subject="My subject"; 
    $txt=$_POST['student_name']." is request Exam-Assignment Deferment";
...
value="<?php echo $row['first_name'].' '.$row['middle_name'].' '.$row['family_name']?>">
  ...
  <div class="col-md-3">
    <label for="exampleInputName2">ID Number:</label><input type="text"  name="Unique_num" class="form-control" placeholder="" value="<?php echo $row['student_id']?>">
  </div>
  <div class="col-md-3">
    <label for="exampleInputName2">Intake:</label><input type="text"  name="Intake_code" class="form-control" placeholder="">
       ...
       <div class="row">
           <div class="col-md-3">
                <label for="exampleInputName2">Course title:</label><input type="text"   name="course_name" class="form-control" placeholder="">
                </div>  
           
            <div class="col-md-12">
           <label class="checkbox-inline e">
 <input type="checkbox" id="inlineCheckbox1"  name="final_exam" value="Exam">Exam
        </label>
        <label class="checkbox-inline a">
          <input type="checkbox" id="inlineCheckbox2"   name="assignment" value="Assignment"> Assignment
        </label>
         </div>
        ...
        <div class="radio">
  <label>
    <input type="radio"  id="optionsRadios1"  class="no" value="illness(medical documentation required including period of illness or disability,the nature of illness)" name="reason_request">
...
<div class="radio">
  <label>
    ...
    bereavement&#42;
        ...
        <div class="col-md-6">
        <input type="radio" id="optionsRadios4"  value="other" name="reason_request" >
    <label for="exampleInputName2">other (please specify)&#42;:</label>
<input type="text"  name="other_reson" id="reason" class="form-control" placeholder="" disabled>
  </div>
      <div class="row">
        <div class="col-md-12">
...
<label class="radio-inline n">
  <input type="radio" name="previously_exam" id="inlineRadio1" value="no"> no
               ...
               <input type="text" name=" name_course" class="form-control" id="courseName" placeholder="" disabled>
               </div>
        </div>
